  ...
  if (step === 'intro') {
    return (
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          <h1 className="text-3xl font-bold text-center mb-6 text-purple-800">Personality Assessment</h1>
          
          <div className="mb-8 text-center">
            <p className="text-lg text-gray-700 mb-4">
              Discover your personality traits and how they influence your learning and career preferences.
            </p>
            <p className="text-gray-600">
              This assessment will help you understand your work style, social preferences, leadership potential, and adaptability.
            </p>
          </div>
          ...
          <div className="mb-8 bg-purple-50 p-4 rounded-lg">
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
              <li>The assessment contains questions about your preferences and behaviors</li>
