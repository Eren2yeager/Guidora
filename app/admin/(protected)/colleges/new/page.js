          ...
          <div className="sm:col-span-3">
            ...
            <select
              ...
              className="mt-1 block w-full px-4 py-3 rounded-lg text-black border border-gray-300 
                       ...
                       placeholder:text-gray-400 placeholder:text-sm"
            >
              <option className="text-black rounded-md" value="Government">Government</option>
              <option className="text-black rounded-md" value="Private">Private</option>
            </select>
          </div>
          ...
          <div className="sm:col-span-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:border-blue-400 transition-all duration-200">
                ...
                />
                <label htmlFor="facilities.hostel" className="ml-3 flex items-center text-gray-700 cursor-pointer select-none">
              ...
              <div className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:border-blue-400 transition-all duration-200">
                <input
                  ...
                  className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition-all duration-200 cursor-pointer"
                />
                <label htmlFor="facilities.lab" className="ml-3 flex items-center text-gray-700 cursor-pointer select-none">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:border-blue-400 transition-all duration-200">
                <input
                  ...
                  className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition-all duration-200 cursor-pointer"
                />
                <label htmlFor="facilities.library" className="ml-3 flex items-center text-gray-700 cursor-pointer select-none">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center p-4 bg-white rounded-lg shadow-sm border border-gray-200 hover:border-blue-400 transition-all duration-200">
                <input
                  ...
                  className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition-all duration-200 cursor-pointer"
                />
                <label htmlFor="facilities.internet" className="ml-3 flex items-center text-gray-700 cursor-pointer select-none">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
