    ...
    try {
      ...
      try {
        ...
        if (!Array.isArray(parsedData)) {
          throw new Error('Data must be an array of courses');
        }
      } catch (err) {
      ...
      setResults(data);
      toast.success(`Successfully processed ${data.results.length} courses`);
    } catch (err) {
    ...
    <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 sm:px-0">
        ...
        <p className="mt-1 text-sm text-gray-600">
          Import multiple courses at once using JSON format.
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            Enter JSON array of course objects or upload a JSON file.
          </p>
        </div>
