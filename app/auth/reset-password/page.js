 ...
 *
 * Props:
 * - value: string (6 digits)
 * - onChange: function (newOtp: string)
 * - disabled: boolean
 * - autoFocus: boolean
 */
  ...
  const handleResendOTP = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        toast({ text: data.error || "Failed to resend code" });
        return;
      }

      toast({ text: "New reset code sent! Check your email." });
      setOtp("")
    } catch (error) {
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <form onSubmit={handleResetPassword} className="space-y-4">
              <div>
                ...
                <OtpInput
                  value={otp} // string of 6 digits, e.g. "123456"
                  onChange={setOtp} // function to update otp value
                  disabled={isLoading} // optional, disables input
                  autoFocus={true} // optional, autofocuses first box
                />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 pr-10 border text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required
                    minLength={6}
                  />
                  <button
